# about-skills Specification

## Purpose
The "What I work with" skills section on `/about` — an accent section heading plus four data-driven category cards (Languages, Frameworks, Data & Messaging, Cloud & DevOps), each listing skill tags, that fade in with a staggered scroll reveal. Gives recruiters a fast read on Abhilash's technical stack. (Sits below the bio owned by the `about-page` capability.)
## Requirements
