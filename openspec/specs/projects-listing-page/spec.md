...
The `/projects` route presents the full showcase listing — a header and a grid of project cards sourced from `content/projects.json` — so visitors can browse projects, understand each project's problem and impact at a glance, and reach individual detail pages.
